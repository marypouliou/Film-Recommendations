...
?>
   ...
   <html>
	...
	<body>
		...
		<!--logo-->
		<a href=""><img id="tv_logo" src="images/tv_logo.jpeg" alt="tv_logo"></a>
		
		<p id = "title_bar">Film Recommendations Based on your Mood</p>
		
		<!-- Navigator bar-->
		<nav id="menu_navigator">
			<a id = "reset_values">Moodslider | </a> <!--to reset the values of the sliders-->
		...
		<div id="main_container">
			...
			<div id = "ranges">
				<div class = "range_group">
					...
					<input type="range" min="0" max="100" value="50" class="slider" id="agitated_calm_range">
					<p class = "right_emotion">Calm</p>
				</div>
				<div class = "range_group">
					<p class = "left_emotion">Happy</p>
					<input type="range" min="0" max="100" value="50" class="slider" id="happy_sad_range">
					<p class = "right_emotion">Sad</p>
				</div>
				<div class = "range_group">
					<p class = "left_emotion">Tired</p>
					<input type="range" min="0" max="100" value="50" class="slider" id="tired_wide_awake_range">
					<p class = "right_emotion">Wide Awake</p>
				</div>
				<div class = "range_group">
					<p class = "left_emotion">Scared</p>
					<input type="range" min="0" max="100" value="50" class="slider" id="scared_fearless_range">
				...
				<?php 
					for ($x = 1; $x <= 5; $x++) { ?>
						<div class = "program_subdiv">
							<img src="images/tv_logo.jpeg" class="image_<?php echo $x; ?>" alt="program">
